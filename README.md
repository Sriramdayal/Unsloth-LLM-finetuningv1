...
Python 3.10+ version, CUDA lastest drivers and Pytorch cuda dependencies must match . Detailed local deployment witn NVIDIA GPU RTX or GTX support will be Addressed in next release stay tuned for updates.
